...
const degreesCelsius = +prompt('Введите пожалуйста температуру в градусах Цельсия');

alert(`температура по Фаренгейту составляет ${(9 / 5) * degreesCelsius + 32} градусов`);
